"""Pub/Sub subscriber for source document upload events."""
...
SourceDocumentHandler = Callable[[dict[str, Any]], None]


class SourceDocumentUploadedSubscriber:
    """Subscribe to source document uploaded events and dispatch handler."""
...
def _extract_event_name(payload: dict[str, Any]) -> str | None:
    ...
    if isinstance(envelope, dict):
        env_event = envelope.get("event_type") or envelope.get("event_name")
