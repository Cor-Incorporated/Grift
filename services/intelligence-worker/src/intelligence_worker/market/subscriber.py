"""Pub/Sub subscriber for market research events."""
...
MarketResearchHandler = Callable[[dict[str, Any]], None]


class MarketResearchRequestedSubscriber:
    """Subscribe to market research request events and dispatch handler."""

    TARGET_EVENT_NAMES = {"market.research.requested", "MarketResearchRequested"}
